...
void readDataSet(int *pointDimension,int *totalNumberPoint){
    string buffer;
<<<<<<<< Updated upstream:MPI-K-Means-Clustering-main/Parallel/kmeans_parallel.cpp
...
========
    ifstream DataSet; DataSet.open("/mnt/c/Users/galan/Documents/GitHub/ACAproject/MPI-K-Means-Clustering-main/DataSet/DataSet100x10.txt");
>>>>>>>> Stashed changes:MPI-K-Means-Clustering-main/Parallel/km_BK.cpp
    if(!DataSet.is_open()){
...
int main(int argc, char* argv[]) {
    ...
    if(my_rank == 0) {
        ...
        bufferSize = 2+pointsXprocessor*pointDimension;
